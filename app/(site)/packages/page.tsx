    ...
    <main className="flex flex-1 flex-col">
      ...
      <section className="relative min-h-[min(70vh,38rem)] overflow-hidden border-b border-[#2A2E33] bg-[#0B0D0F] sm:min-h-[min(75vh,44rem)]">
        ...
        <img
          ...
          className="absolute inset-0 z-0 h-full w-full object-cover object-[center_45%]"
        />
        <div
          aria-hidden
          className="pointer-events-none absolute inset-0 z-[1] bg-gradient-to-r from-[#0B0D0F] via-[#0B0D0F]/75 to-[#0B0D0F]/20"
        />
        <div
          aria-hidden
          className="pointer-events-none absolute inset-y-0 left-0 z-[1] w-full max-w-3xl bg-gradient-to-r from-[#0B0D0F]/92 to-transparent sm:w-[60%]"
        />
        <div
          aria-hidden
          className="pointer-events-none absolute inset-x-0 bottom-0 z-[1] h-2/5 bg-gradient-to-t from-[#0B0D0F]/75 to-transparent"
        />

        <div className="relative z-10 mx-auto flex min-h-[min(70vh,38rem)] w-full max-w-6xl flex-col justify-end px-6 pb-14 pt-28 sm:min-h-[min(75vh,44rem)] sm:pb-20 sm:pt-32">
